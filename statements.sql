...
-- Tu respuesta aquí
SELECT COUNT(*) FROM usuarios_lenguajes WHERE lenguaje = 'Phyton';
...
-- Tu respuesta aquí
SELECT nombre, COUNT(*) AS cantidad_lenguajes 
FROM usuarios_lenguajes 
...
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes ORDER BY LENGHT(lenguaje) DESC LIMIT 1;

-- Ejercicio 23: Seleccionar los usuarios y mostrar la concatenación de su nombre y apellido.
-- Tu respuesta aquí
SELECT CONCAT(nombre, ' ' , apellidos) AS nombre_completo FROM usuarios_lenguajes;

-- Ejercicio 24: Contar cuántos lenguajes diferentes conocen los usuarios mayores de 25 años. 
-- Tu respuesta aquí
SELECT COUNT(DISTINCT lenguaje)
FROM usuarios_lenguajes
WHERE edad > 25;

-- Ejercicio 25: Seleccionar los usuarios que tienen exactamente la misma edad.
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE edad IN(SELECT edad
FROM usuarios_lenguajes
GROUP BY edad
HAVING COUNT(*) > 1
);
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes where edad < 30 order by lenght(lenguaje) desc limit 1;
...
-- Tu respuesta aquí
select count(*) from usuarios_lenguajes where edad between 20 and 25 and lenguajes is not null;
...
-- Tu respuesta aquí
select nombre, edad, edad - (select avg(edad) from usuarios_lenguajes) as diferencia from usuarios_lenguajes;
